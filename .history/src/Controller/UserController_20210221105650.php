...
class UserController extends AbstractController {
    ...
    public function update(Request $request, EntityManagerInterface $entityManagerInterface, int $id): ServerExceptionInterface
    {
        ...
        if(!$user)
        {
            ...
            return new ServerExceptionInterface
        }
    }
