...
class UserController extends AbstractController {
     ...
     * @return void 
     */
    public function __construct(LoggerInterface $loggerInterface, CsrfTokenManagerInterface $csrfTokenManagerInterface, UserPasswordEncoderInterface $encoder, SessionInterface $)
    {
