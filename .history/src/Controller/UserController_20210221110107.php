...
class UserController extends AbstractController {
    ...
    public function update(Request $request, EntityManagerInterface $entityManagerInterface,PasswordEncoderInterface $encoder ,int $id): HttpException | Response
    {
        ...
        $user->password = $user->setPassword($encoder->encodePassword())
    }
